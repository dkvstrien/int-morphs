...
class IntMorphsCardData:
    """
    This is used when extracting data from the IntMorphsDB
    """
...
def create_card_data_dict(
    am_config: IntMorphsConfig,
    config_filter: IntMorphsConfigFilter,
...
def _get_anki_data(
    am_config: IntMorphsConfig, model_id: NotetypeId, tags_object: dict[str, str]
