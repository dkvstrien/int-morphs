...
class CardScore:
    ...
    def __init__(
        self, am_config: IntMorphsConfig, card_morph_metrics: CardMorphsMetrics
    ) -> None:
...
def _should_move_card_to_end(
    am_config: IntMorphsConfig, card_morph_metrics: CardMorphsMetrics
) -> bool:
...
def _get_all_morphs_target_difference(
    am_config: IntMorphsConfig, num_morphs: int
) -> int:
