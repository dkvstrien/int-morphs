...
class KnownMorphsExporterDialog(QDialog):
    def __init__(
        ...
        self.am_config = IntMorphsConfig()
    ...
    def _export_inflections(
        ...
        export_list: list[tuple[str, str, int]] = (
            IntMorphsDB().get_known_lemmas_and_inflections_with_count(known_interval)
        )
    ...
    def _export_lemmas(
        ...
        export_list: list[tuple[str, int]] = IntMorphsDB().get_known_lemmas_with_count(
            known_interval
        )
