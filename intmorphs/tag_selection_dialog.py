...
class TagSelectionDialog(QDialog):  # pylint:disable=too-many-instance-attributes
    # The UI comes from intmorphs/ui/tag_selection.ui which is used in Qt Designer,
    # which is then converted to intmorphs/ui/tag_selection_ui.py,
    ...
    def closeWithCallback(  # pylint:disable=invalid-name
        ...
        self.close()
        aqt.dialogs.markClosed(intmorphs_globals.TAG_SELECTOR_DIALOG_NAME)
        callback()
