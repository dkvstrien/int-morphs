...
from ..intmorphs_config import (
    IntMorphsConfig,
    IntMorphsConfigFilter,
    FilterTypeAlias,
    RawConfigFilterKeys,
    RawConfigKeys,
)
...
class NoteFiltersTab(  # pylint:disable=too-many-instance-attributes
    ...
    def __init__(  # pylint:disable=too-many-arguments
        ...
        aqt.dialogs.register_dialog(
            name=intmorphs_globals.TAG_SELECTOR_DIALOG_NAME,
    ...
    def _setup_note_filters_table(
        self, config_filters: list[IntMorphsConfigFilter]
    ) -> None:
    ...
    def populate(self, use_default_config: bool = False) -> None:
        filters: list[IntMorphsConfigFilter]
    ...
    def _set_note_filters_table_row(
        self, row: int, config_filter: IntMorphsConfigFilter
    ) -> None:
        assert mw is not None
    ...
    def _setup_note_type_cbox(self, config_filter: IntMorphsConfigFilter) -> QComboBox:
        note_type_cbox = QComboBox(self.ui.note_filters_table)
        note_types_string: list[str] = [intmorphs_globals.NONE_OPTION] + [
    ...
    def _setup_fields_cbox(
        self, config_filter: IntMorphsConfigFilter, selected_note_type: str
    ) -> QComboBox:
        assert mw is not None
        ...
        note_type_fields: list[str] = [intmorphs_globals.NONE_OPTION]
    ...
    def _setup_morphemizer_cbox(
        self, config_filter: IntMorphsConfigFilter
    ) -> QComboBox:
        morphemizer_cbox = QComboBox(self.ui.note_filters_table)
        morphemizers: list[str] = [intmorphs_globals.NONE_OPTION] + [
