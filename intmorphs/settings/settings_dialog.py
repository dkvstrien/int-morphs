...
class SettingsDialog(QDialog):  # pylint:disable=too-many-instance-attributes
    ...
    def _init_ui(self) -> None:
        # The UI comes from intmorphs/ui/settings_dialog.ui which is used in Qt Designer,
        # which is then converted to intmorphs/ui/settings_dialog_ui.py,
        ...
        self._config = IntMorphsConfig()
        self._default_config = IntMorphsConfig(is_default=True)
        ...
        self.ui.intmorphs_version_label.setText(
            f"IntMorphs version: {intmorphs_globals.__version__}"
        )
    ...
    def _update_config(
        ...
        intmorphs_config.update_configs(new_config)
        self._config.update()
    ...
    def closeWithCallback(  # pylint:disable=invalid-name
        ...
        self.close()
        aqt.dialogs.markClosed(intmorphs_globals.SETTINGS_DIALOG_NAME)
        callback()
