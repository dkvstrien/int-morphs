...
from .. import intmorphs_config, intmorphs_globals, text_preprocessing
...
def highlight_morphs_jit(
    ...
    if (
        ...
        or field_name == intmorphs_globals.EXTRA_FIELD_HIGHLIGHTED
    ):
        return field_text

    am_config_filter: IntMorphsConfigFilter | None = (
        intmorphs_config.get_matching_filter(context.note())
    )
...
def _dehtml(
    text: str,
    am_config: IntMorphsConfig | None = None,
