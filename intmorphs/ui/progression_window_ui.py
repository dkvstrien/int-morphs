# Form implementation generated from reading ui file 'intmorphs/ui/progression_window.ui'
#
...
class Ui_ProgressionWindow(object):
    def setupUi(self, ProgressionWindow):
        ...
        ProgressionWindow.resize(790, 598)
        ...
        self.morphPriorityCBox = QtWidgets.QComboBox(parent=self.groupBox)
        ...
        self.lemmaRadioButton = QtWidgets.QRadioButton(parent=self.groupBox)
        self.lemmaRadioButton.setEnabled(True)
        self.lemmaRadioButton.setObjectName("lemmaRadioButton")
        self.buttonGroup_2 = QtWidgets.QButtonGroup(ProgressionWindow)
        self.buttonGroup_2.setObjectName("buttonGroup_2")
        self.buttonGroup_2.addButton(self.lemmaRadioButton)
        self.horizontalLayout.addWidget(self.lemmaRadioButton)
        self.inflectionRadioButton = QtWidgets.QRadioButton(parent=self.groupBox)
        self.inflectionRadioButton.setEnabled(True)
        self.inflectionRadioButton.setObjectName("inflectionRadioButton")
        self.buttonGroup_2.addButton(self.inflectionRadioButton)
        self.horizontalLayout.addWidget(self.inflectionRadioButton)
        ...
        self.minPrioritySpinBox = QtWidgets.QSpinBox(parent=self.groupBox)
        ...
        self.maxPrioritySpinBox = QtWidgets.QSpinBox(parent=self.groupBox)
        ...
        self.normalRadioButton = QtWidgets.QRadioButton(parent=self.groupBox_2)
        self.normalRadioButton.setObjectName("normalRadioButton")
        self.buttonGroup = QtWidgets.QButtonGroup(ProgressionWindow)
        self.buttonGroup.setObjectName("buttonGroup")
        self.buttonGroup.addButton(self.normalRadioButton)
        self.horizontalLayout_5.addWidget(self.normalRadioButton)
        self.cumulativeRadioButton = QtWidgets.QRadioButton(parent=self.groupBox_2)
        self.cumulativeRadioButton.setObjectName("cumulativeRadioButton")
        self.buttonGroup.addButton(self.cumulativeRadioButton)
        self.horizontalLayout_5.addWidget(self.cumulativeRadioButton)
        ...
        self.binSizeSpinBox = QtWidgets.QSpinBox(parent=self.groupBox_2)
        ...
        self.horizontalLayout_2.addWidget(self.binSizeSpinBox)
        spacerItem3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem3)
        self.verticalLayout_3.addLayout(self.horizontalLayout_2)
        self.verticalLayout_4.addWidget(self.groupBox_2)
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setContentsMargins(-1, 10, -1, 20)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        spacerItem4 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_4.addItem(spacerItem4)
        self.viewProgressPushButton = QtWidgets.QPushButton(parent=self.centralwidget)
        self.viewProgressPushButton.setObjectName("viewProgressPushButton")
        self.horizontalLayout_4.addWidget(self.viewProgressPushButton)
    ...
    def retranslateUi(self, ProgressionWindow):
        ...
        self.groupBox.setTitle(_translate("ProgressionWindow", "Morphs"))
        self.label_6.setText(_translate("ProgressionWindow", "Morph Priority File:"))
        ...
        self.label_2.setText(_translate("ProgressionWindow", "Morph Priority Range:"))
        self.label_4.setText(_translate("ProgressionWindow", "to"))
        self.groupBox_2.setTitle(_translate("ProgressionWindow", "Bins"))
        self.label_3.setText(_translate("ProgressionWindow", "Bin type:"))
        self.normalRadioButton.setText(_translate("ProgressionWindow", "Normal"))
        self.cumulativeRadioButton.setText(_translate("ProgressionWindow", "Cumulative"))
        self.label_5.setText(_translate("ProgressionWindow", "Bin Size:"))
        self.viewProgressPushButton.setText(_translate("ProgressionWindow", "View Progress Report"))
