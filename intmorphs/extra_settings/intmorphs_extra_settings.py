...
class IntMorphsExtraSettings(QSettings):
    def __init__(self) -> None:
        assert mw is not None
        extra_settings_path = Path(
            mw.pm.profileFolder(), "intmorphs_extra_settings.ini"
        )
        super().__init__(str(extra_settings_path), QSettings.Format.IniFormat)

    def save_current_intmorphs_version(self) -> None:
        self.setValue(keys.General.ANKIMORPHS_VERSION, intmorphs_globals.__version__)
