...
You can download the latest version of IntMorphs from [ankiweb](https://ankiweb.net/shared/info/472573498). You can
find
previous versions [on github releases](https://github.com/mortii/anki-morphs/releases).

IntMorphs parses text into morphs by using external morphemizers, and different languages will require different
...
>- [MeCab](https://en.wikipedia.org/wiki/MeCab) morphemizer (recommended)  
   ...
   morphemizer will show up as the option `IntMorphs: Japanese`
>
...
>- [Jieba](https://github.com/fxsjy/jieba?tab=readme-ov-file#jieba-1) morphemizer (recommended)  
   ...
   morphemizer will show up as the option `IntMorphs: Chinese`
>
...
After the installation is complete, some [setup](setup.md) is required to get IntMorphs to work. After that you can
run [Recalc](usage/recalc.md) and you will be good to go!

[Here is an overview](installation/changes-to-anki.md) of the changes that are made to Anki after installing IntMorphs.