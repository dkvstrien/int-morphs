...
After installing IntMorphs you will find that some changes have been made to Anki.
...
IntMorphs adds new options in the `Browse` window

![browser-right-click.png](../../img/browser-right-click.png)

These options can be accessed either from the context menu when right-clicking cards, or from the `IntMorphs` menu at
...
An IntMorphs submenu is added to the Anki `Tools` menu:
