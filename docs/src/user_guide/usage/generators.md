...
IntMorphs provides the following three generators:
...
This is the tool IntMorphs uses to split text into morphs.
...
by IntMorphs, so you can delete or modify the other columns if you want.
