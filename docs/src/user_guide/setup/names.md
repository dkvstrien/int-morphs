...
>**Note**:
>
>- **Memory Usage**: IntMorphs loads the entire list of names into memory and compares against it each time you review 
...
You can have IntMorphs automatically filter out specified names found on your cards. This feature is designed so users
