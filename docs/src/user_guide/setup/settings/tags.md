...
As IntMorphs processes cards, it automatically adds and removes various tags. You can customize the names
...
* **Set known and skip**:  
  ...
  a card, it will be given this tag. Do **not** delete cards that have this tag, as IntMorphs relies on them to track
...
* **All morphs known**:  
  ...
  without IntMorphs losing track of which morphs you know. This can be useful if you want to trim down your card
  collection.
