...
The text found in the [note filter: field](../settings/note-filter.md#field) is extracted and analyzed by IntMorphs.
IntMorphs can then place
...
- **am-score**:  
  The [score](../../usage/recalc.md#scoring-algorithm) IntMorphs determined the card to have
- **am-score-terms**:  
