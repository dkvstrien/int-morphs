...
from intmorphs.intmorphs_config import IntMorphsConfig, IntMorphsConfigFilter
from intmorphs.highlighting import highlight_just_in_time
from intmorphs.highlighting.highlight_just_in_time import highlight_morphs_jit
from intmorphs.highlighting.ruby_classes import (
    FuriganaRuby,
    KanaRuby,
    KanjiRuby,
    Ruby,
...
from intmorphs.highlighting.text_highlighter import TextHighlighter
from intmorphs.morpheme import Morpheme
from intmorphs.morphemizers import (
    morphemizer_utils,
)
from intmorphs.morphemizers.morphemizer import Morphemizer
...
def _get_dynamic_highlighted_text(
    ...
    patches: list[Any] = [
        ...
        mock.patch.object(
            ...
            "get_matching_filter",
            lambda _: mock.Mock(
                spec=IntMorphsConfigFilter, morphemizer_description=""
            ),
        ),
        mock.patch.object(
            morphemizer_utils,
