...
from intmorphs.intmorphs_config import IntMorphsConfig
from intmorphs.morpheme import Morpheme
from intmorphs.morphemizers import spacy_wrapper
from intmorphs.morphemizers.spacy_morphemizer import SpacyMorphemizer
...
def fake_environment_fixture() -> Iterator[None]:
    ...
    _config_data = None
    with open("intmorphs/config.json", encoding="utf-8") as file:
    ...
    patch_config_mw = mock.patch.object(intmorphs_config, "mw", mock_mw)
