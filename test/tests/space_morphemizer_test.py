...
import intmorphs.morphemizers.morphemizer
from intmorphs.morpheme import Morpheme
from intmorphs.morphemizers import spacy_wrapper
from intmorphs.morphemizers.morphemizer_utils import get_morphemizer_by_description
...
def _fake_environment_fixture() -> Iterator[None]:
    ...
    intmorphs.morphemizers.morphemizer_utils.available_morphemizers = None
