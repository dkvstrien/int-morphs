...
from intmorphs.generators.generators_output_dialog import (
    GeneratorOutputDialog,
    OutputOptions,
)
from intmorphs.generators.generators_utils import Column
from intmorphs.generators.generators_window import GeneratorWindow
...
def test_readability_report(  # pylint:disable=too-many-arguments, unused-argument
    ...
    _set_morphemizer(
        generator_window=gw, morphemizer_description="IntMorphs: Japanese"
    )
