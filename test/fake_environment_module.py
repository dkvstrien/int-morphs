...
from intmorphs.extra_settings import intmorphs_extra_settings
from intmorphs.generators import (
...
from intmorphs.morphemizers import spacy_wrapper
from intmorphs.progression import progression_utils, progression_window
from intmorphs.recalc import anki_data_utils, caching, recalc_main
...
def create_mw_patches(mock_mw: AnkiQt) -> list[Any]:
    return [
        ...
        mock.patch.object(intmorphs_db, "mw", mock_mw),
        mock.patch.object(intmorphs_config, "mw", mock_mw),
        ...
        mock.patch.object(intmorphs_extra_settings, "mw", mock_mw),
...
def create_am_db_patches() -> list[Any]:
    return [
        mock.patch.object(reviewing_utils, "IntMorphsDB", FakeDB),
        mock.patch.object(recalc_main, "IntMorphsDB", FakeDB),
        mock.patch.object(caching, "IntMorphsDB", FakeDB),
        mock.patch.object(readability_report_generator, "IntMorphsDB", FakeDB),
        mock.patch.object(study_plan_generator, "IntMorphsDB", FakeDB),
        mock.patch.object(progression_window, "IntMorphsDB", FakeDB),
        mock.patch.object(progression_utils, "IntMorphsDB", FakeDB),
        mock.patch.object(known_morphs_exporter, "IntMorphsDB", FakeDB),
    ]
...
def create_misc_patches(_priority_files_dir: str, _known_morphs_dir: str) -> list[Any]:
    ...
    return [
        ...
        mock.patch.object(intmorphs_globals, "PRIORITY_FILES_DIR_NAME", _priority_files_dir),
        mock.patch.object(intmorphs_globals, "KNOWN_MORPHS_DIR_NAME", _known_morphs_dir),
    ]
    # fmt: on
