...
from intmorphs import intmorphs_globals as am_globals
from intmorphs.intmorphs_config import RawConfigFilterKeys as FilterKeys
from intmorphs.intmorphs_config import RawConfigKeys as ConfigKeys

DEFAULT_CONFIG_PATH = Path("intmorphs", "config.json")
...
default_config_filter[FilterKeys.MORPHEMIZER_DESCRIPTION] = (
    "IntMorphs: Simple Space Splitter"
)
...
config_big_japanese_collection_filter[FilterKeys.MORPHEMIZER_DESCRIPTION] = "IntMorphs: Japanese"
# fmt: on
...
config_use_stability_for_known_threshold_filter[FilterKeys.MORPHEMIZER_DESCRIPTION] = "IntMorphs: Japanese"
# fmt: on
